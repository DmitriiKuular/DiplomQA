...
|  |  | 1.2. Ввести валидные данные цифрами, колиество вводимых значений цифрами должно быть равно 15т | Под полем "Номер карты" появляется сообщение об ошибке красным шрифтом "Неверный формат" |
